...
namespace Second.API.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            return Ok(ToPagedResult(products, pagination));
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            var products = await _productService.GetBySellerProfileIdAsync(sellerProfileId, cancellationToken);
            return Ok(ToPagedResult(products, pagination));
        }
        ...
        private static PagedResult<ProductDto> ToPagedResult(IReadOnlyList<ProductDto> products, PaginationParameters pagination)
        {
